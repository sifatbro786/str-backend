...
router.get("/admin/id/:id", protect, checkRole("super_admin", "admin"), ctrl.getBlogById);
...
router.post("/", sanitizeHtml("content", "excerpt"), createBlogRules, validate, ctrl.createBlog);
router.patch("/:id", sanitizeHtml("content", "excerpt"), ctrl.updateBlog);
